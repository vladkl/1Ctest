...
Процедура СкрытьЛишниеГруппыНаФорме(ОткрытиеИзПанелиАдминистрирования)
	...
	ЭтоПолноправныйПользователь = Истина; //Пользователи.ЭтоПолноправныйПользователь(, Истина);
...
Процедура УстановитьРасписаниеОтложенногоОбновления(НовоеРасписание)
	...
	Для Каждого Задание Из Задания Цикл
		...
		ОбновлениеИнформационнойБазыСлужебный.ИзменитьЗадание(Задание, ПараметрыЗадания);
	КонецЦикла;
